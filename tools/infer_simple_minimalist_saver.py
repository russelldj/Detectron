...
def main(args):
    output_file = "{}/output.h5".format(args.output_dir)
    if os.path.isfile(output_file): # delete the output file if it exists
    ...
    for i, im_name in enumerate(im_list):
        ...
        format_and_save(cls_boxes, cls_segms, cls_keyps, i, output_file)
